...
class MenuBarTextEditor(MenuBarANSIEditor):
    ...
    def leave_menu_bar(self):
        ...
        self.sid_data.menutexteditor.display_editor(self.util.sid_data.color_array,self.util.sid_data.color_bgarray, self.util.sid_data.input_values, self.sid_data.menu_box.values)
