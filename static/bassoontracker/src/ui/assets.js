UI.Assets = (function(){
	...
	me.preLoad = function(next){
		...
		FetchService.json(assetUrl("/static/bassoontracker/skin/spritemap_v4.json"),function(data){
			spriteMap = data;
			createSprites();
		});

		Y.loadImage(assetUrl("/static/bassoontracker/skin/spritesheet_v4.png"),function(img){
			spriteSheet = img;
			createSprites();
		})
