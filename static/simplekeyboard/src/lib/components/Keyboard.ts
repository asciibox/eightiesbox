  ...
  getInputCandidates(
    ...
    const layoutCandidates = Object.keys(layoutCandidatesObj).filter(
      (layoutCandidate: string) => {
        ...
        const matches = [...(inputSubstr as any).matchAll(regexp)];
    ...
    if (this.candidateBox) {
      this.candidateBox.show({
        ...
        onSelect: (selectedCandidate: string, e: MouseEvent) => {
          ...
          if (
            enableLayoutCandidatesKeyPress &&
            typeof this.options.onKeyPress === "function"
          )
    ...
    this.dispatch((instance) => {
      ...
      if (
        ...
        if (instance.options.rtl) {
          selectionStart = instance.utilities.getRtlOffset(
            selectionStart,
            instance.getInput()
          );
          selectionEnd = instance.utilities.getRtlOffset(
            selectionEnd,
            instance.getInput()
          );
        }
